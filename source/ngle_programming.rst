...
Michael Lorenz <macallan1888@gmail.com> started on a manual for programming
the HCRX and PCI Visualize EG graphic cards.
His announcement on the mailing list is here:

https://lore.kernel.org/linux-parisc/20251229060048.141359d4@glenmorangie/

The latest version of the manual is here:

https://cvsweb.netbsd.org/bsdweb.cgi/src/sys/arch/hppa/doc/

You will find a copy below, but check out the original website for a newer version.

The de-obfuscated header describing the registers lives here:

https://cvsweb.netbsd.org/bsdweb.cgi/src/sys/dev/ic/nglereg.h


Manual for programming HCRX and PCI Visualize EG (copy)
-------------------------------------------------------

.. code-block:: text

        $NetBSD: ngle_manual.txt,v 1.4 2025/12/29 06:00:45 macallan Exp $
        ...
        The ROM is in word mode, as expected of a GSC device, with every 32bit word
